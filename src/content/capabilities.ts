...
export const builtinAgents: BuiltinAgent[] = [
  ...
  },
  {
    ...
    name: '网站开发 Agent',
    category: '产品与交付',
    summary: '把业务目标实现为可运行的网站或 Web 应用，并完成响应式适配和浏览器验收。',
    input: '需求、品牌素材、参考页面和现有工程',
    output: '前端代码、生产构建、验收截图与可访问站点',
    audience: '产品、市场、设计与研发团队',
    capabilities: ['网站设计', '前端开发', '响应式适配', '浏览器验收'],
  },
  {
    code: 'ai-video',
    name: 'AI 视频制作 Agent',
